                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="mt-8 p-6 rounded-3xl bg-accent text-white shadow-xl shadow-accent/20 relative overflow-hidden group">
                            ...
                            <a <a href="https://wa.me/2349022334478" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full py-3 bg-white text-accent rounded-xl text-xs font-black shadow-lg hover:bg-white/90 transition-all gap-2"> target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full py-3 bg-white text-accent rounded-xl text-xs font-black shadow-lg hover:bg-white/90 transition-all gap-2">
