...
import { VirtualAccountModule } from "@/components/VirtualAccountModule";
...
const quickActions = [
  ...
  { icon: Plane, label: "Flights", path: "#", color: "text-primary bg-primary/10", border: "border-primary/20", disabled: true },
  { icon: Building, label: "Hotels", path: "#", color: "text-blue-600 dark:text-blue-400 bg-blue-500/10", border: "border-blue-500/20", disabled: true },
  { icon: Landmark, label: "Bank Transfer", path: "#", color: "text-accent-foreground bg-accent/15", border: "border-accent/20", disabled: true },
];
...
const Dashboard = () => {
  ...
  const { verifyPayment } = useFundWallet();
            ...
            <div className="flex gap-2.5">
              <Dialog open={fundOpen} onOpenChange={setFundOpen}>
                ...
                <DialogContent className="rounded-3xl border-none shadow-2xl max-w-[380px] mx-auto">
                  ...
                  <VirtualAccountModule enabledGateways={enabledGateways} fundingFee={fundingFee} />
                </DialogContent>
              </Dialog>
